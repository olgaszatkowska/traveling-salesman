...
plt.plot(num_points_range, rand_tour_lenghts, label='Nearest Neighbor', color='green')
...
plt.plot(num_points_range, rand_elapsed_times, label='Nearest Neighbor', color='green')
plt.xlabel('Number of Points')
